...
python main.py --config config/sensitivity.yml grid --top 3 --output data/grid_sensitivity_results.parquet
python main.py --config config/wide.yml grid --n-jobs 8 --top 3 --output data/AAPL_grid_wide_results.parquet
```
