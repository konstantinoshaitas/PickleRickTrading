...
python main.py --config config/BTC_test.yml backtest --plot
...
python main.py --config config/wide.yml grid --n-jobs 8 --top 3 --min-trades 0.5 --output data/test_super_speed.parquet
```
